...
module.exports = class PetController {
    ...
    static async create (req, res){
        ...
        //iniciando como true pois todo cachorro cadastrado inicialmente estará disponível para adoção
        ...
        //o resultado do req.files é um array de objetos, o map irá fazer a extração do campo onde está presente o nome da imagem
        images.map((image) => {
    ...
    static async concludeAdoption(req, res){
        ...
        res.status(200).json({
            message: "Parabéns, adoção feita com sucesso!"
        })
